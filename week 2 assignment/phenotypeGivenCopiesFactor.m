function phenotypeFactor = phenotypeGivenCopiesFactor( ...
...
temp = zeros(phenotypeFactor.card);
for k_p1 = 1:numAlleles
  for k_p2 = 1:numAlleles
    p = alphaList(allelesToGenotypes(k_p1, k_p2));
    temp(1, k_p1, k_p2) = p;
    temp(2, k_p1, k_p2) = 1 - p;
  end
end

phenotypeFactor.val = temp(:)';
